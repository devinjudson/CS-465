...
const tripsList = async (req, res) => {
    const q = await Model
        ...
        // Uncomment the following line of code to show results of query
        // on the console
        // console.log(q);
...
//GET: /trips/:tripCode -lists a signle trip
// Regardless of outcome, response must incluse HTML status code
// and JSON message to the requesting client
...
//POST: /trips/:tripCode -lists a signle trip
// Regardless of outcome, response must incluse HTML status code
// and JSON message to the requesting client
const tripsAddTrip = async (req, res) => {
    try {
        ...
        return res.status(400).json(err); // Handle errors
    }
};
